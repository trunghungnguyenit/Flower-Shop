...
function CollectionPage() {
    ...
    const categories = [
        ...
        },
        {
            id: "bo-hoa",
            name: "Bó hoa",
            count: products.filter((p)=>p.category === "bo-hoa").length
        },
        {
            id: "lang-hoa",
            name: "Lẵng hoa",
            count: products.filter((p)=>p.category === "lang-hoa").length
        }
    ];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4d13ca1c._.js.map