        ...
        const occasionWedding = async ()=>{
            try {
                ...
                if (res.ok && Array.isArray(res.data)) {
                    const filteredProducts = res.data.filter((item)=>Array.isArray(item.occasionIds) && item.occasionIds.includes("dam-cuoi"));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b8b5ed2a._.js.map