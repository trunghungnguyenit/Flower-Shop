...
export default function OccasionsPage() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="pt-24 pb-16 lg:pb-24">
        <div className="mx-auto max-w-[1100px] px-4 lg:px-8">
          ...
          <nav className="flex items-center gap-2 text-sm font-body mb-8">
            ...
            <span className="text-[var(--text-primary)] font-medium">Dịp lễ</span>
          </nav>
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-xl bg-[var(--primary)]/10 flex items-center justify-center">
                <Calendar className="w-6 h-6 text-[var(--primary)]" strokeWidth={1.5} />
              </div>
            ...
            <p className="font-body text-[var(--text-secondary)] max-w-2xl mx-auto mb-8" style={{ fontSize: "18px", lineHeight: 1.7 }}>
              Từ Tết Nguyên Đán đến sinh nhật, từ đám cưới đến khai trương - chúng tôi có những mẫu hoa phù hợp cho mọi dịp lễ quan trọng trong cuộc sống.
            </p>
      ...
      {/* Occasions Grid */}
      <section ref={ref} id="danh-sach-dip-le" className="py-16 lg:py-24 bg-[var(--background-muted)]">
        <div className="mx-auto max-w-[1200px] px-4 lg:px-8">
          ...
          >
            ...
            <p className="font-body text-[var(--text-secondary)] max-w-2xl mx-auto" style={{ fontSize: "16px", lineHeight: 1.7 }}>
              Mỗi dịp lễ đều có ý nghĩa riêng và cần những loại hoa phù hợp. Hãy chọn dịp lễ để xem các mẫu hoa được gợi ý.
            </p>
          </motion.div>
              ...
              >
                <Link href={occasion.href}>
                  <div className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="relative aspect-[4/3] overflow-hidden">
                      ...
                      <div className="absolute top-4 left-4">
                        <div className={cn(
                          ...
                          occasion.color === "red" && "bg-red-500/20 text-red-100",
                          occasion.color === "pink" && "bg-pink-500/20 text-pink-100",
                          occasion.color === "rose" && "bg-rose-500/20 text-rose-100",
                          occasion.color === "orange" && "bg-orange-500/20 text-orange-100",
                          occasion.color === "gray" && "bg-gray-500/20 text-gray-100",
                          occasion.color === "purple" && "bg-purple-500/20 text-purple-100",
                          occasion.color === "emerald" && "bg-emerald-500/20 text-emerald-100"
                        )}>
                          <occasion.icon className="w-5 h-5" strokeWidth={1.5} />
                        </div>
                      </div>
                      ...
                      <div className="absolute bottom-4 left-4 right-4">
                        <h3 className="font-display text-white font-semibold mb-1" style={{ fontSize: "18px" }}>
                          {occasion.title}
                        </h3>
                      </div>
                    </div>
                    ...
                    {/* Content */}
                    <div className="p-6">
                      <p className="font-body text-[var(--text-secondary)] mb-4" style={{ fontSize: "14px", lineHeight: 1.6 }}>
        ...
        <div className="mx-auto max-w-[900px] px-4 lg:px-8">
          ...
          >
            ...
            <p className="text-white/90 mb-8 max-w-lg mx-auto font-body" style={{ fontSize: "16px", lineHeight: 1.7 }}>
              Liên hệ với chúng tôi để được tư vấn về các loại hoa phù hợp cho dịp lễ đặc biệt của bạn.
            </p>
