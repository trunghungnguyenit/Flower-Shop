    ...
    <main className="min-h-screen">
      ...
      <div className="pt-[73px]">
        ...
        <section className="relative h-[50vh] lg:h-[60vh] overflow-hidden">
          <Image src="/placeholder.svg?height=800&width=1600" alt="Hoa Tết" fill className="object-cover" priority />
          <div className="absolute inset-0 bg-gradient-to-r from-foreground/60 to-foreground/20" />
          <div className="absolute inset-0 flex items-center">
            <div className="mx-auto max-w-7xl px-4 lg:px-8">
              <div className="max-w-xl">
                <p className="text-primary-foreground/80 text-sm tracking-[0.3em] uppercase mb-3">Xuân 2024</p>
                <h1 className="text-4xl lg:text-5xl font-semibold text-card mb-4">Hoa Tết Rực Rỡ</h1>
        ...
        <section className="py-12 lg:py-16 bg-secondary/30">
          <div className="mx-auto max-w-4xl px-4 lg:px-8 text-center">
            <h2 className="text-2xl lg:text-3xl font-semibold text-foreground mb-6">Hoa Tết - Sắc Xuân Rực Rỡ</h2>
        ...
        <section className="py-16 bg-primary/10">
          <div className="mx-auto max-w-3xl px-4 text-center">
            <h2 className="text-2xl lg:text-3xl font-semibold text-foreground mb-4">Đặt Hoa Tết Ngay Hôm Nay</h2>
            <p className="text-muted-foreground mb-8">
              Đặt sớm để nhận ưu đãi giảm giá 10% cho đơn hàng trước ngày 20 tháng Chạp
            </p>
