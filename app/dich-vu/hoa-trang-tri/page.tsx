    ...
    <main className="min-h-screen">
      ...
      <div className="pt-[73px]">
          ...
          <div className="absolute inset-0 flex items-center">
            <div className="mx-auto max-w-7xl px-4 lg:px-8">
              <div className="max-w-xl">
                <p className="text-primary-foreground/80 text-sm tracking-[0.3em] uppercase mb-3">Không Gian Đẹp</p>
                <h1 className="text-4xl lg:text-5xl font-semibold text-card mb-4">Hoa Trang Trí</h1>
        ...
        <section id="san-pham" className="py-12 lg:py-16">
          <div className="mx-auto max-w-7xl px-4 lg:px-8">
            <h2 className="text-2xl font-semibold text-foreground mb-8 text-center">Bộ Sưu Tập Hoa Trang Trí</h2>
        ...
        <section className="py-16 bg-primary/10">
          <div className="mx-auto max-w-3xl px-4 text-center">
            <h2 className="text-2xl lg:text-3xl font-semibold text-foreground mb-4">Đặt Hoa Trang Trí Ngay</h2>
